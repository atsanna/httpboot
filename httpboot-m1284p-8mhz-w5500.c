// Httpboot - Internet-Bootloader for Atmega1284p and WizNet W5500, developed using Atmel Studio.
// (C) Copyright 2014 Sebastian Wangnick.
// See http://s.wangnick.de/doku.php?id=iot-basisstation for design details.
